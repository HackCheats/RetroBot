...
namespace PoGo.RetroBot.Logic
{
    ...
    public class PokemonConfig
    {
        ...
        public string WarningColor = "DarkYellow";
        public string PokestopColor = "Cyan";
        public string FarmingColor = "Magenta";
        public string SniperColor = "White";
        public string RecyclingColor = "DarkMagenta";
        public string BerryColor = "DarkYellow";
        public string CaughtColor = "Green";
        public string FleeColor = "DarkYellow";
        public string TransferColor = "DarkGreen";
        public string EvolveColor = "DarkGreen";
        public string EggColor = "DarkYellow";
        public string UpdateColor = "White";
        public string InfoColor = "DarkCyan";
        public string NewColor = "Green";
        public string SoftBanColor = "Red";
        public string LevelUpColor = "Magenta";
    ...
    public class LogicSettings : ILogicSettings
    {
        ...
        public string ErrorColor => _settings.PokemonSettings.ErrorColor;
        public string WarningColor => _settings.PokemonSettings.WarningColor;
        public string PokestopColor => _settings.PokemonSettings.PokestopColor;
        public string FarmingColor => _settings.PokemonSettings.FarmingColor;
        public string SniperColor => _settings.PokemonSettings.SniperColor;
        public string RecyclingColor => _settings.PokemonSettings.RecyclingColor;
        public string BerryColor => _settings.PokemonSettings.BerryColor;
        public string CaughtColor => _settings.PokemonSettings.CaughtColor;
        public string FleeColor => _settings.PokemonSettings.FleeColor;
        public string TransferColor => _settings.PokemonSettings.TransferColor;
        public string EvolveColor => _settings.PokemonSettings.EvolveColor;
        public string EggColor => _settings.PokemonSettings.EggColor;
        public string UpdateColor => _settings.PokemonSettings.UpdateColor;
        public string InfoColor => _settings.PokemonSettings.InfoColor;
        public string NewColor => _settings.PokemonSettings.NewColor;
        public string SoftBanColor => _settings.PokemonSettings.SoftBanColor;
        public string LevelUpColor => _settings.PokemonSettings.LevelUpColor;
        public string DebugColor => _settings.PokemonSettings.DebugColor;
    }
}
