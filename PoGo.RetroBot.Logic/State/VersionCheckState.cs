...
namespace PoGo.RetroBot.Logic.State
{
    public class VersionCheckState : IState
    {
        public const string VersionUri =
            "https://rawgit.com/HackCheats/RetroBot/master/PoGo.RetroBot.Logic/Properties/AssemblyInfo.cs";

        public const string LatestReleaseApi =
            "https://api.github.com/repos/HackCheats/RetroBot/releases/latest";

        private const string LatestRelease =
            "https://github.com/HackCheats/RetroBot/releases";
        ...
        public async Task<IState> Execute(ISession session, CancellationToken cancellationToken)
        {
            ...
            var remoteReleaseUrl =
                $"https://github.com/HackCheats/RetroBot/releases/download/v{RemoteVersion}/";
