...
using PoGo.RetroBot.CLI.Resources;
using PoGo.RetroBot.Logic;
...
namespace PoGo.RetroBot.CLI
{
    internal class Program
    {
        private static readonly ManualResetEvent QuitEvent = new ManualResetEvent(false);
        private static string subPath = "";
        private static Uri strKillSwitchUri = new Uri("https://raw.githubusercontent.com/HackCheats/RetroBot/master/KillSwitch.txt");
        ...
        private static void Main(string[] args)
        {
            ...
            Console.SetWindowSize(179, 44);
            Console.Title = "RetroBot";
            ...
            ProgressBar.start("RetroBot is starting up", 10);
